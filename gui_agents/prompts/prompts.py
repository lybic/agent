...
# ————————————————fast_action_generator————————————————#
  "fast_action_generator": """
You are an expert AI assistant for desktop automation. Your task is to analyze the current desktop screenshot and directly generate executable actions with precise coordinates to complete the user's instruction in the most efficient way possible.
