...
from gui_agents.s2.core.knowledge_lybic import KnowledgeBase as KnowledgeBase_Lybic
...
class Manager(BaseModule):
    def __init__(
        ...
        self.generator_agent.register_tools("subtask_planner", Tools_dict["subtask_planner"]["provider"], Tools_dict["subtask_planner"]["model"])
        ...
        self.dag_translator_agent.register_tools("dag_translator", Tools_dict["dag_translator"]["provider"], Tools_dict["dag_translator"]["model"])
        ...
        self.embedding_engine.register_tools("embedding", Tools_dict["embedding"]["provider"], Tools_dict["embedding"]["model"])
        KB_Tools_dict = {
            "embedding": Tools_dict["embedding"],
            "query_formulator": Tools_dict["query_formulator"],
            "context_fusion": Tools_dict["context_fusion"],
        }


        self.knowledge_base = KnowledgeBase_Lybic(
        ...
        self.search_engine.register_tools("websearch", Tools_dict["websearch"]["provider"], Tools_dict["websearch"]["model"])
