...
class KnowledgeBase(BaseModule):
    ...
    def retrieve_narrative_experience(self, instruction: str) -> Tuple[str, str]:
        ...
        if instruction_embedding is None:
            ...
            instruction_embedding = self.embedding_engine.execute_tool("embedding_engine", {"str_input": instruction})
        ...
        for key in knowledge_base:
            ...
            if candidate_embedding is None:
                ...
                candidate_embedding = self.embedding_engine.execute_tool("embedding_engine", {"str_input": key})
